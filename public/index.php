...
//General
$router->add('login', ['controller' => 'accountController', 'action' => 'login', 'namespace' => 'General']);
...
$router->add('fairBox/{id:\d+}', ['controller' => 'ProductController', 'action' => 'index', 'namespace' => 'Fairsoft']);
